...
const ProductsAxiosPage = () => {
  ...
  const fetchProductById = async (id: string) => {
    ...
    setError(null);
    try {
      const data = await getProductByIdWithAxios(id);
  ...
  const handleUpdateProduct = async (e: React.FormEvent) => {
    ...
    setError(null);
    try {
      await updateProductWithAxios(selectedProduct.id, formData);
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">Products Page (Axios)</h1>
...
export default ProductsAxiosPage;
